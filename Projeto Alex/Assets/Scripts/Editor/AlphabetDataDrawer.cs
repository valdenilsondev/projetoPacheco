...
[CustomEditor(typeof(AlplabetData))]
...
public class AlphabetDataDrawer : Editor
{
    ...
    private ReorderableList AlphanetWrongList;
    ...
    private void OnEnable() {
        ...
        InitializeReordableList(ref AlphanetWrongList, "AlphabetWrong", "Alphabet Wrong");
    }
    ...
    public override void OnInspectorGUI() 
    {
        ...
        AlphanetWrongList.DoLayoutList();
